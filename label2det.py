...
if __name__ == '__main__':
    # json.load(open('/Volumes/DATASET/BDD100k/bdd100k/annotations/bdd100k_to_coco_labels_images_val2018.json', 'r'))
    # open('/Volumes/DATASET/BDD100k/bdd100k/annotations/bdd100k_to_coco_labels_images_val2018.json', 'r')
    main()
