...
def parse_args():
    ...
    parser.add_argument('--network', type=str, default='resnet101_v1b',
...
def get_dataset(dataset, args):
    if dataset.lower() == 'bdd':
        train_dataset = gdata.BDDInstance(root='/data1/datasets/bdd100k/', splits='instances_train2018', skip_empty=True, use_color_maps=False)
        val_dataset = gdata.BDDInstance(root='/data1/datasets/bdd100k/', splits='instances_val2018', skip_empty=False, use_color_maps=False)
